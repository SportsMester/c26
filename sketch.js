...
function draw() {
  ...
  text("Enzo",50,100);
  textSize(40);
  text("Projeto C-26",550,600);
}


//ESCOLHA A OPÇÃO CORRETA PARA APLICAR UMA TECLA PRESSIONADA E ALTERAR
// A POSIÇÃO DO OBJETO BOLA PARA A ESQUERDA QUANDO A TECLA DE SETA PARA CIMA FOR PRESSIONADA
